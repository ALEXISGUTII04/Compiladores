...
import AnalisisDescendente.Programa1;
import AnalisisDescendente.Programa5;
import AnalisisDescendente.Programa3;
import AnalisisDescendente.Programa4;
import AnalisisDescendente.Programa2;
import AnalisisAscendente.Programa10;
import AnalisisAscendente.Programa7;
import AnalisisAscendente.Programa6;
import AnalisisAscendente.Programa9;
import AnalisisAscendente.Programa8;
import javax.swing.*;
...
public class Interfaz extends JFrame {
    ...
    public Interfaz() {
        ...
        JMenu menuAnalizar = new JMenu("Ejecutar Código");
        JMenuItem ejecutar = new JMenuItem("Analizar");
        ...
        panelInferior.add(new JLabel("Consola:"), BorderLayout.NORTH);
    ...
    private void ejecutarAnalisisLexico(String codigo, String compilador) {
        ...
        switch (compilador) {
            case "Compilador1" -> analizarConCompilador(codigo, Compilador1::transformar, Compilador1::evaluar, 4);
            case "Compilador2" -> analizarConCompilador(codigo, Compilador2::transformar, Compilador2::evaluar, 7);
            case "Compilador3" -> analizarConCompilador(codigo, Compilador3::transformar, Compilador3::evaluar, 13);
            case "Compilador4" -> analizarConCompilador(codigo, Compilador4::transformar, Compilador4::evaluar, 48);
    ...
    private void ejecutarAnalisisDescendente(String codigo, String programa) throws IOException {
        ...
        List<String> entrada = switch (programa) {
            case "Programa1" -> Programa1.leerArchivo(temp.getAbsolutePath());
            case "Programa2" -> Programa2.leerArchivo(temp.getAbsolutePath());
            case "Programa3" -> Programa3.leerArchivo(temp.getAbsolutePath());
            case "Programa4" -> Programa4.leerArchivo(temp.getAbsolutePath());
            case "Programa5" -> Programa5.leerArchivo(temp.getAbsolutePath());
            default -> null;
        };
    ...
    private void ejecutarAnalisisAscendente(String programa) throws Exception {
        ...
        switch (programa) {
            case "Programa6" -> Programa6.analizar(codigo);
            case "Programa7" -> Programa7.analizar(codigo);
            case "Programa8" -> Programa8.analizar(codigo);
            case "Programa9" -> Programa9.analizar(codigo);
            case "Programa10" -> Programa10.analizar(codigo);
